          ...
          <div class="row">
            ...
            <div class="row mt-2">
              <div class="p-2 bd-highlight d-flex justify-content-between">
                <a type="button" href="/admin/products" class="btn btn-outline-secondary">
                  <i class="fa-solid fa-backward"></i> Trở lại
                </a>
                <button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#themSanPhamChiTiet">
                    ...
                    <c:when test="${not empty lstPD}">
                      <c:forEach items="${lstPD}" var="s" varStatus="i">
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-warning rounded-pill edit-btn" data-bs-toggle="modal" data-bs-target="#editModal" title="Chỉnh Sửa"
                               data-id="${s.id}" data-size="${s.size.id}" data-color="${s.color.id}" data-status="${s.status}" data-quantity="${s.quantity}">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                            <a class="btn btn-danger rounded-pill" data-toggle="tooltip" title="Xóa" data-id="${s.id}" onclick="return confirmDelete('/admin/products/deleteProductDetail/${s.id}')">
                  ...
                  <div class="modal-body d-flex flex-column gap-3">
                    <div class="row">
                      <div class="form-group w-50 col">
                        ...
                        <input type="text" name="productID" class="form-control" disabled readonly value="${product.id}" />
                      </div>
                      <div class="form-group w-50 col">
                    ...
                    <div class="row">
                      <div class="form-group col">
                        ...
                        <input type="number" class="form-control" min="0" placeholder="Số Lượng" name="quantity" required />
                      </div>
                    </div>
                    <div class="row">
                      <label for="images">Chọn ảnh:</label>
                      <input type="file" id="images" name="images" multiple required onchange="previewImages(event)" />
                ...
                <div class="modal-content" style="font-size: 14px">
                  ...
                  <div class="modal-body d-flex flex-column gap-3">
                    ...
                    <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" name="status" checked value="true" />
        ...
        <c:otherwise>
          ...
          <div class="w-100">
            <form action="/admin/products" method="GET" class="row g-1">
              <div class="col-5">
                <input name="timKiemSanPham" class="form-control" type="search" placeholder="Tìm sản phẩm" aria-label="Search" style="font-size: 14px" value="${timKiemSanPham}" />
              </div>
              <div class="col-2">
              ...
              <div class="col-5 d-flex justify-content-between">
                ...
                <button type="button" class="btn btn-outline-primary flex-fill mx-1" style="font-size: 14px" data-bs-toggle="modal" data-bs-target="#themSanPham">
                  <i class="fa-solid fa-circle-plus"></i> Thêm Mới
                </button>
              </div>
            </form>
                  ...
                  <c:forEach items="${products}" var="sp" varStatus="i">
                    <tr>
                      ...
                      <td class="align-middle d-flex justify-content-end gap-2">
                        <a class="btn edit-btn mb-0" data-bs-toggle="modal" data-bs-target="#editModal" data-id="${sp.id}" data-code="${sp.code}" data-name="${sp.name}" data-price="${sp.price}" data-status="${sp.status}" data-description="${sp.description}" data-category="${sp.categoryDetail.id}" title="Chỉnh Sửa">
                          <i class="fa-solid fa-pen-to-square"></i>
                        </a>
                        <a class="btn delete-btn mb-0" data-toggle="tooltip" data-placement="top" title="Xóa" data-id="${sp.id}" onclick="return confirmDelete()">
                          <i class="fa-solid fa-trash"></i>
                        </a>
                        <a href="/admin/products?productID=${sp.id}" class="btn btn-secondary mb-0" data-toggle="tooltip" data-placement="top" title="Xem Chi Tiết">
