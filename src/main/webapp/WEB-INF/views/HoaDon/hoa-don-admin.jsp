...
<body class="g-sidenav-show bg-gray-100 text-sm">
    ...
    <main class="main-content max-height-vh-100 h-100 border-radius-lg pe-3">
                ...
                <form action="/admin/order" method="GET" class="row g-1">
                    ...
                    <div class="col-2">
                        ...
                        >
                            ...
                            <option value="CONFIRMED" ${status eq 'CONFIRMED' ? 'selected' : ''}>Xác Nhận</option>
                            <option value="CANCELLED" ${status eq 'CANCELLED' ? 'selected' : ''}>Đã Huỷ</option>
                        </select>
                    </div>
        ...
        <c:if test="${not empty selectedOrder}">
            <div class="modal fade show" id="orderDetailModal" tabindex="-1" aria-labelledby="orderDetailModalLabel" style="display: block;">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <table class="table table-bordered no-left-right-border">
                                        <tr>
                                            ...
                                            <td><fmt:formatDate value="${selectedOrder.createdAt}" pattern="dd/MM/yyyy HH:mm:ss" /></td>
                                        </tr>
                                        <tr>
                                            <th>Ngày cập nhật</th>
                                            <td><fmt:formatDate value="${selectedOrder.updatedAt}" pattern="dd/MM/yyyy HH:mm:ss" /></td>
                                        </tr>
                                        <tr>
                                            <th>Tổng tiền</th>
                                            <td class="fw-bold">
                                                <fmt:formatNumber value="${selectedOrder.totalAmount}" pattern="#,##0" /> VND
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Ghi chú</th>
