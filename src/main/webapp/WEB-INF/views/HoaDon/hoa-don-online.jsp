                                ...
                                <tbody>
                                    <c:forEach items="${listHoaDonOnline}" var="hd" varStatus="i">
                                        <tr>
                                            ...
                                            <%-- <td>${hd.trangThai == 1 ? "Thành công" : (hd.trangThai == 2 ? "Chờ xác
                                                nhận" : "Đang giao hàng")}</td>--%>
                                                <td>
                                                    ...
                                                    <c:if test="${hd.trangThai == 4}">
                                                        <span class="badge bg-info text-dark">Giao hàng thành
                                                            công</span>
                                                    </c:if>
                                                ...
                                                <td>
                                                    <a href="/t-shirt-luxury/admin/hoa-don-online/detail?idHoaDonOnline=${hd.id}"
                                                        class="btn btn-secondary rounded-pill" data-toggle="tooltip"
