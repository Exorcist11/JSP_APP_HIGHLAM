    ...
    padding-left: 10px;">
                        ...
                        <div class="logo-and-search d-flex" style="gap: 164px;">
                            ...
                            <div class="search-favourite-cart-popup" style="margin-left: 0;">
                                ...
                                <a href="#" data-bs-toggle="offcanvas" data-bs-target="#cartDrawer"
                    ...
                    <div class="header-popup" style="box-shadow: 0px 5px 10px rgba(0, 0, 0, 0.1);">
                        ...
                        <ul class="menu-popup">
                            <li class="item-danh-muc"><a href="/t-shirt-luxury/ao-nam" class="name-danh-muc-popup ">Áo
                                    Nam
                                </a>
                            </li>
                    ...
                    <div class="danh-muc-page-ctsp"
                        ...
                        <ul id="type-tshirt">
                            ...
                            <ul class="login-and-signin">
                                ...
                                <li class="button-login pe-3"><a href="#" class="ten-danh-muc hover-change-color">ĐĂNG
                                        NHẬP</a>
                                </li>
                                <li class="button-sign-in"><a href="#" class="ten-danh-muc hover-change-color">ĐĂNG
                                        KÝ</a>
                                </li>
                            </ul>
                        </ul>
                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="../images/ao_phong_boxy/DEVOTUS/black.webp" class="d-block w-100"
                                        alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="../images/ao_phong_boxy/DEVOTUS/wash.webp" class="d-block w-100"
                                        alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="../images/ao_phong_boxy/DEVOTUS/white.webp" class="d-block w-100"
                                        alt="...">
                                </div>
                            </div>
            ...
            <div class="size" style="margin-top: 5px;">
                ...
                <div class="counter">
                    ...
                    <button type="button" class="btn" id="increase"><b>+</b></button>
                            ...
                            <div class="order" style="margin-top: 20px;">
                                ...
                                <button type="submit" class="btn btn-dark" style="width:185px">THÊM VÀO GIỎ
                                    HÀNG</button>
                            ...
                            <div class="accordion" id="accordionExample" style="margin-top: 20px">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <P> Chi tiết:
                                                <br>
                                                ►Chất liệu có sự kết hợp của vải Rayon an toàn cho da, thoáng khí, hút
                                                ẩm tốt và đặc
                                                biệt là ít nhăn và có độ bền cao
                                            </P>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <p> ►Giảm đến 15% trên tổng hóa đơn khi mua hàng ( tại cửa hàng ) vào tháng
                                                sinh nhật.</p>
                                            <p> ►Giao hàng nội thành Hà Nội chỉ từ 15.000đ trong vòng 24 giờ.</p>
                                            <p> ►Tích điểm 3-8% giá trị đơn hàng cho mỗi lần mua và trừ tiền vào lần mua
                                                tiếp theo.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <p>►Có thể giặt tay hay giặt máy đều được (ưu tiên giặt tay để tăng tuổi thọ
                                                của sản phẩm)
                                            </p>
                                            <p>►Lộn trái sản phẩm khi giặt, không giặt chung sản phẩm trắng với quần áo
                                                tối màu.</p>
                                            <p>►Sử dụng xà phòng trung tính,không sử dụng xà phòng có chất tẩy mạnh.
                                            </p>
                                            <p>►Không sử dụng chất tẩy, không ngâm sản phẩm. </p>
                                            <p>►Hạn chế sấy ở nhiệt độ cao, bảo quản nơi khô ráo, thoáng mát, không phơi
                                                trực tiếp dưới
                                                ánh nắng mặt trời.</p>
                ...
                <div class="comment " style="margin-top: 100px; ">
                    ...
                    <div class="cmt" style="display: flex; align-items: center; gap: 10px; margin: 20px;">
                        <!-- Hình ảnh đại diện -->
                        <img src="/images/linhtinh/avt.jpg" alt="Avatar"
