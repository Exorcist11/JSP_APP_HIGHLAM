                                    ...
                                    <c:forEach items="${anhSanPham}" var="anh" varStatus="i">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="/t-shirt-luxury/admin/anh-san-pham/delete?id=${anh.id}"
                        ...
                        <div class="modal-content" style="font-size: 14px;">
                            ...
                            <div class="modal-body">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="Tên Ảnh"
                                        name="tenAnhSanPham">
                                    <label for="floatingInput">Tên Ảnh</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="Url Ảnh"
                                        name="maAnhSanPham">
