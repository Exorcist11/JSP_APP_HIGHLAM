                        ...
                        <div class="row">
                            ...
                            <form action="/t-shirt-luxury/admin/mau-sac/update?id=${mauSac.id}" method="POST">
                                <div class="form-floating mb-3">
                                    <input readonly name="maMauSac" type="text" class="form-control" id="floatingInput"
                                        value="${mauSac.maMauSac}">
                                    <label for="floatingInput">Mã Màu Sắc</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input name="tenMauSac" type="text" class="form-control" id="floatingInput"
                                        placeholder="Tên Màu Sắc" value="${mauSac.tenMauSac}">
                                ...
                                <div class="form-floating mb-3 mt-3">
                                    <input name="moTa" type="text" class="form-control" id="floatingInput"
                                        placeholder="Mô tả" value="${mauSac.moTa}">
