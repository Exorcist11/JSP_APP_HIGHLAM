                        ...
                        <div class="row">
                            ...
                            <form action="/t-shirt-luxury/admin/chat-lieu/update?id=${chatLieu.id}" method="POST">
                                <div class="form-floating mb-3">
                                    <input readonly name="maChatLieu" type="text" class="form-control"
                                        id="floatingInput" value="${chatLieu.maChatLieu}">
                                    <label for="floatingInput">Mã Chất Liệu</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input name="tenChatLieu" type="text" class="form-control" id="floatingInput"
                                        placeholder="Tên Chất Liệu" value="${chatLieu.tenChatLieu}">
                                ...
                                <div class="form-floating mb-3 mt-3">
                                    <input name="moTa" type="text" class="form-control" id="floatingInput"
                                        placeholder="Mô tả" value="${chatLieu.moTa}">
